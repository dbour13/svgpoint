...
namespace svgpoints
{
    internal static class SVGMath
    {
        ...
        /// <param name="xy1">Cubic Beizer P0 parameter for x or y (i.e. the first curve x or y coordinate)</param>
        /// <param name="xy2">Cubic Beizer P0 parameter for x or y (i.e. the second curve x or y coordinate)</param>
        /// <param name="xy3">Cubic Beizer P0 parameter for x or y (i.e. the ending x or y coordinate)</param>
